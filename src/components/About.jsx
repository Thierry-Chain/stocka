...
export default function About() {
  return (
    <Container minW="full" pl="0" pr="0">
      <VStack h="80vh" justifyContent="space-around">
        <Box>
          <Heading
            fontWeight="bold"
        ...
        >
          ...
          <Text textAlign="left">
            <AddIcon color="blue.700" mx="2" fontSize="md" /> Helps to make
            stock control in a period
          </Text>
          <Text textAlign="left">
            <AddIcon color="blue.700" mx="2" fontSize="md" /> Shows current
            state of stock
          </Text>
          <Text textAlign="left">
            <AddIcon color="blue.700" mx="2" fontSize="md" />
      ...
      <SimpleGrid columns={['1', '2', '3']} spacing={['1', '5']}>
        ...
        <Link mx="auto" href="https://github.com/thierry-Chain" isExternal>
          <Image h="250px" src={other} />
        </Link>
      </SimpleGrid>
